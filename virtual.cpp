...
int main()
{
  ...
  bp->gun();  //CALL //ahe pn khota ahe mahanun toh ghali gela ani mg call derived la gela mahnun second out is derived gun
  bp->sun();  //CALL  3000  //ahe pn virual ahe mg te khali gela lkhali navtha mahnun ahe tech call zala
